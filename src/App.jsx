...
// Make sure this import points to the correct file if you renamed it
...
function MyApp() {
  ...
  const renderContent = () => {
     switch (selectedMenuKey) {
        ...
        default:
          // Defaulting to dashboard view - Apply same column changes here
          return (
              <Row gutter={[24, 24]}>
                <Col xs={24} lg={17}>
                  <Space direction="vertical" size="large" style={{ width: '100%' }}>
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      <Sidebar
        collapsed={collapsed} onCollapse={setCollapsed} selectedKey={selectedMenuKey}
      ...
      <Layout style={{
          ...
          overscrollBehaviorY: 'contain', // *** ADDED THIS LINE ***
          display: 'flex',
