...
const CombinedBillsOverview = ({ style }) => {
    ...
    const columns = [
        ...
        { title: 'Name', dataIndex: 'name', key: 'name', width: 60, align: 'left', sorter: (a, b) => a.name.localeCompare(b.name), render: (text) => (<div style={{ textAlign: 'left' }}><Text strong>{text}</Text></div>) },
